...
MODULES_ADD_PATH=$COCOS2DX_ROOT
MODULES_ADD_PATH1="\$(call import-add-path,$MODULES_ADD_PATH)"
MODULES_ADD_PATH=$MODULES_ADD_PATH/cocos2dx/platform/third_party/android/prebuilt
MODULES_ADD_PATH2="\$(call import-add-path,$MODULES_ADD_PATH)"
